...
def find_object_from_picture(image):
    endpoint = 'https://lpcustomvision.cognitiveservices.azure.com/customvision/v3.0/Prediction/5399347c-dcb7-4322-a49c-b9d9384a8eb2/classify/iterations/Iteration1/image'
    Prediction_Key = r'd702077b37cc4bc6b921721e694b294a'
    Content_Type = r'application/octet-stream'
    response = requests.post(
        url=endpoint, headers={'Prediction-Key': Prediction_Key, 'Content-Type': Content_Type}, data=image)
